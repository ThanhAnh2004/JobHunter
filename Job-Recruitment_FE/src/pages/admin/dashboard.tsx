...
const DashboardPage = () => {
    ...
    return (
        <div style={{ padding: '5px' }}>
            <h2 style={{ marginBottom: '24px', color: '#0f172a', fontWeight: 700, letterSpacing: '0.5px' }}>Tổng quan hệ thống</h2>
            ...
            <Row gutter={[20, 20]}>
                ...
                <Col span={24} sm={12} md={6}>
                    <Card className="premium-card" bordered={false}>
                        <div className="stat-card-content">
                            <div className="stat-details">
                                <div className="stat-title">Tổng công ty</div>
                                <div className="stat-number">
                ...
                <Col span={24} sm={12} md={6}>
                    <Card className="premium-card" bordered={false}>
                        <div className="stat-card-content">
                            <div className="stat-details">
                                <div className="stat-title">Việc làm đang tuyển</div>
                                <div className="stat-number">
            ...
            <Row gutter={[20, 20]} style={{ marginTop: '25px' }}>
                <Col span={24}>
                    <Card title="Phân tích trạng thái hồ sơ ứng tuyển" className="premium-card" bordered={false}>
                            ...
                            <Col span={24} md={14}>
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
                                    <div>
                                        ...
                                        <Progress percent={getPercent(stats?.countPendingResumes ?? 0)} strokeColor="#faad14" showInfo={false} strokeWidth={8} />
                                    </div>
                                    <div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px', color: '#334155' }}>
                                        ...
                                        <Progress percent={getPercent(stats?.countReviewingResumes ?? 0)} strokeColor="#1890ff" showInfo={false} strokeWidth={8} />
                                    </div>
                                    <div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px', color: '#334155' }}>
                                        ...
                                        <Progress percent={getPercent(stats?.countApprovedResumes ?? 0)} strokeColor="#52c41a" showInfo={false} strokeWidth={8} />
                                    </div>
                                    <div>
                                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px', color: '#334155' }}>
                                        ...
                                        <Progress percent={getPercent(stats?.countRejectedResumes ?? 0)} strokeColor="#ff4d4f" showInfo={false} strokeWidth={8} />
                                    </div>
                                </div>
                            </Col>
                        </Row>
